	...
	function _initClass() {
		...
		*/
		VerticalScrollbar.prototype.resize = function(maintainPosition) {
			...
			if (maintainPosition && this.previousScrollPercentage !== 0 && (previousContentHeight !== this.contentHeight || previousBarHeight !== this.barHeight)) {
			...
			if (this.handleHeight === this.barHeight) {
				this.disable();
			} else {
